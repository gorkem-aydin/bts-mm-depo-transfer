sap.ui.define([
	...
	return Opa5.extend("com.bizim.depotransfer.ZMM007_DEPO_TRANSFER.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/bizim/depotransfer/ZMM007_DEPO_TRANSFER/localService/mockserver"], function (mockserver) {
