sap.ui.define([
	"sap/ui/test/Opa5",
	"com/bizim/depotransfer/ZMM007_DEPO_TRANSFER/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"com/bizim/depotransfer/ZMM007_DEPO_TRANSFER/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("com.bizim.depotransfer.ZMM007_DEPO_TRANSFER.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "GetAnaDepoMagazaSet/" + sObjectId;
