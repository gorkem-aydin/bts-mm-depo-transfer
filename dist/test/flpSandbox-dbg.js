		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Depolar Arasi Transfer",
									"targetURL": "#DepolarArasiTransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DepolarArasiTransfer-display": {
								"semanticObject": "DepolarArasiTransfer",
								"action": "display",
								"description": "Depolar Arasi Transfer",
								"title": "Depolar Arasi Transfer",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bizim.depotransfer.ZMM007_DEPO_TRANSFER",
									"url": sap.ui.require.toUrl("com/bizim/depotransfer/ZMM007_DEPO_TRANSFER")
								}
							}
						}
					}
